export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[hsl(212,100%,12%)] via-[hsl(212,80%,8%)] to-[hsl(220,60%,14%)] dark:from-[hsl(212,100%,8%)] dark:via-[hsl(212,80%,5%)] dark:to-[hsl(220,60%,10%)]">
      {/* Subtle grid pattern */}
      <div
