...
export const helpersCatalog: HelperDefinition[] = [
  ...
  },
  {
    id: 'order_it',
    name: 'Order It',
    description: 'Create orders with products and payment details on a contact',
    category: 'data',
    icon: ShoppingCart,
    popular: false,
    status: 'available',
  ...
  // Integration
  {
    id: 'donor_search',
    name: 'Donor Search',
    description: 'Look up donor profiles and wealth screening via Donor Search API',
    category: 'integration',
    icon: Heart,
    popular: false,
    status: 'available',
  ...
  },
  {
    id: 'trello_it',
    name: 'Trello It',
    description: 'Create Trello cards with checklists from contact data',
    category: 'integration',
    icon: Kanban,
    popular: false,
    status: 'available',
