...
export const helpersCatalog: HelperDefinition[] = [
  ...
  },
  {
    id: 'advance_math',
    name: 'Advance Math',
    description: 'Perform advanced mathematical operations (power, square root, absolute value, rounding, min, max) on contact field values',
    category: 'data',
    icon: Calculator,
    popular: false,
    status: 'available',
  ...
  {
    id: 'hook_it_v2',
    name: 'Hook It V2 (Tag Router)',
    description: 'Route webhook events to apply different tags based on event type',
    category: 'integration',
    icon: Webhook,
    popular: false,
    status: 'available',
  ...
  {
    id: 'hook_it_v3',
    name: 'Hook It V3 (Field Mapper)',
    description: 'Extract webhook payload fields and save to CRM contact custom fields',
    category: 'integration',
    icon: Webhook,
    popular: false,
    status: 'available',
  ...
  {
    id: 'hook_it_v4',
    name: 'Hook It V4 (Multi-Goal)',
    description: 'Fire multiple goals sequentially for each webhook event',
    category: 'integration',
    icon: Webhook,
    popular: false,
    status: 'available',
  ...
  {
    id: 'hook_it_by_tag',
    name: 'Hook It By Tag (Conditional)',
    description: 'Process webhook only if contact has required tags and lacks forbidden tags',
    category: 'integration',
    icon: Webhook,
    popular: false,
    status: 'available',
  ...
  {
    id: 'ip_notifications',
    name: 'IP Notifications',
    description: 'Send notifications based on visitor IP geolocation (country, region, city)',
    category: 'automation',
    icon: Globe,
    popular: false,
    status: 'available',
  ...
  },
  {
    id: 'ip_redirects',
    name: 'IP Redirects',
    description: 'Generate dynamic redirect URLs based on visitor IP geolocation (country-specific landing pages)',
    category: 'automation',
    icon: Navigation,
    popular: false,
    status: 'available',
  ...
  // ========== ADDITIONAL HELPERS (from legacy WordPress) ==========

  // Contact
  {
    id: 'contact_updater',
    name: 'Contact Updater',
    description: 'Update contact fields via HTTP POST with a secure update key',
    category: 'contact',
    icon: RefreshCw,
    popular: false,
    status: 'available',
  ...
  // Data
  {
    ...
    description: 'Generate personalized countdown timer images for emails and pages',
    category: 'data',
    icon: Timer,
    popular: false,
    status: 'available',
  ...
  },
  {
    id: 'email_scrub_it',
    name: 'Email Scrub It',
    description: 'Validate and scrub email addresses with deliverability scoring and tagging',
    category: 'data',
    icon: MailX,
    popular: false,
    status: 'available',
  ...
  },
  {
    id: 'quote_it',
    name: 'Quote It',
    description: 'Insert a random inspirational quote into a contact field',
    category: 'data',
    icon: Quote,
    popular: false,
    status: 'available',
  ...
  },
  {
    id: 'order_it',
    name: 'Order It',
    description: 'Create a Keap order for a contact with product, quantity, and promo codes',
    category: 'integration',
    icon: ShoppingCart,
    popular: false,
    status: 'available',
  ...
  },
  {
    id: 'query_it_basic',
    name: 'Query It',
    description: 'Run saved searches and reports to perform bulk actions on contacts',
    category: 'data',
    icon: Database,
    popular: false,
    status: 'available',
  ...
  },
  {
    id: 'search_it',
    name: 'Search It',
    description: 'Use saved searches to find and process matching contacts',
    category: 'data',
    icon: Search,
    popular: false,
    status: 'available',
  ...
  // Automation
  {
    id: 'route_it',
    name: 'Route It',
    description: 'Route contacts to different URLs based on tags, fields, and conditions',
    category: 'automation',
    icon: Navigation,
    popular: false,
    status: 'available',
  ...
  {
    id: 'route_it_by_custom',
    name: 'Route It By Custom Field',
    description: 'Route contacts to different URLs based on custom field values',
    category: 'automation',
    icon: Navigation,
    popular: false,
    status: 'available',
  ...
  {
    id: 'route_it_by_day',
    name: 'Route It By Day',
    description: 'Route contacts to different URLs based on the day of the week',
    category: 'automation',
    icon: Calendar,
    popular: false,
    status: 'available',
  ...
  {
    id: 'route_it_by_time',
    name: 'Route It By Time',
    description: 'Route contacts to different URLs based on time of day with timezone awareness',
    category: 'automation',
    icon: Clock,
    popular: false,
    status: 'available',
  ...
  {
    id: 'route_it_geo',
    name: 'Route It - Geographic',
    description: 'Route contacts to different URLs based on geographic location (country, region, city)',
    category: 'automation',
    icon: Globe,
    popular: false,
    status: 'available',
  ...
  },
  {
    id: 'route_it_score',
    name: 'Route It - Score',
    description: 'Route contacts to different URLs based on lead score ranges',
    category: 'automation',
    icon: Target,
    popular: false,
    status: 'available',
  ...
  {
    id: 'route_it_source',
    name: 'Route It - Source',
    description: 'Route contacts to different URLs based on traffic source (UTM parameters, referrer, or lead source field)',
    category: 'automation',
    icon: MousePointerClick,
    popular: false,
    status: 'available',
  ...
  {
    id: 'video_trigger_it',
    name: 'Video Trigger It',
    description: 'Trigger tags and goals based on video watch progress milestones',
    category: 'automation',
    icon: Video,
    popular: false,
    status: 'available',
  ...
  },
  {
    id: 'limit_it',
    name: 'Limit It',
    description: 'Limit or throttle how many times a helper can run per contact',
    category: 'automation',
    icon: ToggleLeft,
    popular: false,
    status: 'coming_soon',
  ...
  },
  {
    id: 'match_it',
    name: 'Match It',
    description: 'Match and compare field values with conditional branching',
    category: 'automation',
    icon: CheckCircle,
    popular: false,
    status: 'coming_soon',
  ...
  // Integration
  {
    id: 'donor_search',
    name: 'Donor Search',
    description: 'Look up donor profiles and wealth screening via DonorLead.net API',
    category: 'integration',
    icon: Heart,
    popular: false,
    status: 'available',
  ...
  },
  {
    id: 'dropbox_it',
    name: 'Dropbox It',
    description: 'Create Dropbox folders per contact with template copying and sharing',
    category: 'integration',
    icon: HardDrive,
    popular: false,
    status: 'available',
  ...
  {
    id: 'email_attach_it',
    name: 'Email Attach It',
    description: 'Attach forwarded emails to contact records from authorized senders',
    category: 'integration',
    icon: Paperclip,
    popular: false,
    status: 'available',
  ...
  },
  {
    id: 'everwebinar',
    name: 'EverWebinar',
    description: 'Register contacts for EverWebinar sessions and sync field data',
    category: 'integration',
    icon: Video,
    popular: false,
    status: 'available',
  ...
  {
    id: 'facebook_custom_audience',
    name: 'Facebook Custom Audience',
    description: 'Add or remove contacts from Facebook Custom Audiences for ad targeting',
    category: 'integration',
    icon: Facebook,
    popular: false,
    status: 'available',
  ...
  },
  {
    ...
    description: 'Import leads from Facebook Lead Ad forms and map fields to CRM',
    category: 'integration',
    icon: Facebook,
    popular: false,
    status: 'available',
  ...
  {
    id: 'google_drive_it',
    name: 'Google Drive It',
    description: 'Create Google Drive folders per contact for organized file storage',
    category: 'integration',
    icon: HardDrive,
    popular: false,
    status: 'available',
  ...
  },
  {
    id: 'gotowebinar',
    name: 'GoToWebinar',
    description: 'Register contacts for GoToWebinar events and track attendance',
    category: 'integration',
    icon: Video,
    popular: false,
    status: 'available',
  ...
  },
  {
    id: 'stripe_hooks',
    name: 'Stripe Hooks',
    description: 'Sync Stripe events (charges, subscriptions, invoices) to CRM contacts',
    category: 'integration',
    icon: CreditCard,
    popular: false,
    status: 'available',
  ...
  },
  {
    id: 'trello_it',
    name: 'Trello It',
    description: 'Create Trello cards with contact data using templates',
    category: 'integration',
    icon: Kanban,
    popular: false,
    status: 'available',
  ...
  },
  {
    id: 'upload_it',
    name: 'Upload It',
    description: 'Accept file uploads linked to contacts and trigger goals on completion',
    category: 'integration',
    icon: Upload,
    popular: false,
    status: 'available',
  ...
  },
  {
    id: 'webinar_jam',
    name: 'WebinarJam',
    description: 'Register contacts for WebinarJam sessions and sync webinar data',
    category: 'integration',
    icon: Video,
    popular: false,
    status: 'available',
  ...
  },
  {
    id: 'zoom_meeting',
    name: 'Zoom Meeting',
    description: 'Create Zoom meetings per contact and track attendance with tagging',
    category: 'integration',
    icon: Video,
    popular: false,
    status: 'available',
  ...
  {
    id: 'zoom_webinar_oauth',
    name: 'Zoom Webinar (OAuth)',
    description: 'Register contacts for Zoom webinars with OAuth and attendance tracking',
    category: 'integration',
    icon: Video,
    popular: false,
    status: 'available',
  ...
  {
    id: 'zoom_webinar_absentee',
    name: 'Zoom Webinar Absentee',
    description: 'Process webinar registrants who did not attend (no-shows)',
    category: 'integration',
    icon: Video,
    popular: false,
    status: 'available',
  ...
  {
    id: 'zoom_webinar_participant',
    name: 'Zoom Webinar Participant',
    description: 'Process webinar attendees and apply segmentation tags based on engagement',
    category: 'integration',
    icon: Video,
    popular: false,
    status: 'available',
  ...
  // Notification
  {
    id: 'email_scrub_validate',
    name: 'Email Address Validator',
    description: 'Validate email address format and domain for deliverability',
    category: 'notification',
    icon: ShieldCheck,
    popular: false,
    status: 'available',
