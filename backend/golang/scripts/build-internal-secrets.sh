...
export STRIPE_PRICE_START_ANNUAL="${STAGE_UPPER}_INTERNAL_STRIPE_PRICE_START_ANNUAL"
export STRIPE_PRICE_GROW_ANNUAL="${STAGE_UPPER}_INTERNAL_STRIPE_PRICE_GROW_ANNUAL"
export STRIPE_PRICE_DELIVER_ANNUAL="${STAGE_UPPER}_INTERNAL_STRIPE_PRICE_DELIVER_ANNUAL"
...
STRIPE_PRICE_START_ANNUAL="${!STRIPE_PRICE_START_ANNUAL:-price_start_annual_placeholder}"
STRIPE_PRICE_GROW_ANNUAL="${!STRIPE_PRICE_GROW_ANNUAL:-price_grow_annual_placeholder}"
STRIPE_PRICE_DELIVER_ANNUAL="${!STRIPE_PRICE_DELIVER_ANNUAL:-price_deliver_annual_placeholder}"
...
STRIPE_JSON=$(jq -n \
  ...
  --arg psa "$STRIPE_PRICE_START_ANNUAL" \
  --arg pga "$STRIPE_PRICE_GROW_ANNUAL" \
  --arg pda "$STRIPE_PRICE_DELIVER_ANNUAL" \
  '{
    secret_key: $sk,
    publishable_key: $pk,
    webhook_secret: $ws,
    ...
    price_grow: $pg,
    price_deliver: $pd,
    price_start_annual: $psa,
    price_grow_annual: $pga,
    price_deliver_annual: $pda
  }')
