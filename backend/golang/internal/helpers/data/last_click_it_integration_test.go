...
func TestLastClickIt_Integration_WithEmailStats(t *testing.T) {
	if testing.Short() {
	...
	mockConnector := &mockConnectorForLastClickIt{
		fieldValues: map[string]interface{}{
			...
			"_email_stats.integration@example.com.LastClickDate": "2024-02-08T10:30:00Z",
		},
	}
...
func TestLastClickIt_Integration_FallbackGenericField(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test")
	}
	...
	mockConnector := &mockConnectorForLastClickIt{
		fieldValues: map[string]interface{}{
			...
			"LastClickDate": "2024-02-08T11:45:00Z",
		},
		getFieldError: map[string]error{
			"_email_stats.fallback@example.com.LastClickDate": fmt.Errorf("stats not supported"),
		},
	}
...
func TestLastClickIt_Integration_NoDataAvailable(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test")
	}
	...
	mockConnector := &mockConnectorForLastClickIt{
		...
		getFieldError: map[string]error{
			"_email_stats.nodata@example.com.LastClickDate": fmt.Errorf("not found"),
